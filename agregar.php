...
<head>
	...
	<title>Servidores SIS - 624</title>
...
<body>
	...
	<div class="container">
		<div class="content">
			<h2>Datos del Estudiante &raquo; Agregar datos</h2>
			<hr />
			...
			if(isset($_POST['add'])){
				...
				$cek = mysqli_query($con, "SELECT * FROM estudiantes WHERE ci='$ci'");
				if(mysqli_num_rows($cek) == 0){
					$insert = mysqli_query($con, "INSERT INTO estudiantes(ci, nombres, costo)
					VALUES('$ci','$nombres', $costo)") or die(mysqli_error());
			...
			<form class="form-horizontal" action="" method="post">
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="text" name="ci" class="form-control" placeholder="Código" required>
					</div>
				</div>
				<div class="form-group">
